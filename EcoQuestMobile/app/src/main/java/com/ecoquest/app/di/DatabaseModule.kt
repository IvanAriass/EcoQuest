...
object DatabaseModule {
    ...
    @Provides
    fun provideUsuarioCosmeticoDao(db: EcoQuestDatabase): UsuarioCosmeticoDao = db.usuarioCosmeticoDao()

    @Provides
    fun provideMensajeDao(db: EcoQuestDatabase): MensajeDao = db.mensajeDao()
}
